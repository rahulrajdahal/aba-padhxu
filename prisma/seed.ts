...
async function main() {
    ...
    const user = await prisma.user.create({ data: { name: 'admin', email: 'admin@me.com', password: bcrypt.hashSync('?=VK-^Kin.$X7C,', salt), avatar: '1708552824810-meistericons.png', isSuperAdmin: true, role: 'SELLER', } })
